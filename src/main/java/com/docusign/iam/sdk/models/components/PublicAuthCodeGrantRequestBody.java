 ...
 * 
 * <p>This grant uses Proof Key for Code Exchange (PKCE) to authenticate securely without requiring a
 * client secret.
 */
public class PublicAuthCodeGrantRequestBody {
    ...
    /**
     * The code verifier used to authenticate the request. This value is generated by the client and must
