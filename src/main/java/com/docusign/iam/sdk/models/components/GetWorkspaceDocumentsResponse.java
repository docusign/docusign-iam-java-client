...
public class GetWorkspaceDocumentsResponse {
    ...
    /**
     * The number of documents returned in the response. Always equal or less than the `count` of the
     * request
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * The total number of documents in the workspace applicable to the request regardless of pagination.
     * It may not always be computed
     */
    @JsonInclude(Include.NON_ABSENT)
