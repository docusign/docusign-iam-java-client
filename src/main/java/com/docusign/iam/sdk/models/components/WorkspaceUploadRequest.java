...
public class WorkspaceUploadRequest {
     ...
     * The ID of the upload request
     */
    public WorkspaceUploadRequest withUploadRequestId(String uploadRequestId) {
        Utils.checkNotNull(uploadRequestId, "uploadRequestId");
        this.uploadRequestId = uploadRequestId;
        return this;
    }
     ...
     * The ID of the workspace
     */
    public WorkspaceUploadRequest withWorkspaceId(String workspaceId) {
        Utils.checkNotNull(workspaceId, "workspaceId");
        this.workspaceId = workspaceId;
        return this;
    }
     ...
     * The name of the upload request
     */
    public WorkspaceUploadRequest withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the upload request
     */
    public WorkspaceUploadRequest withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The description of the upload request
     */
    public WorkspaceUploadRequest withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * The description of the upload request
     */
    public WorkspaceUploadRequest withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }

    public WorkspaceUploadRequest withUploadRequestOwner(WorkspaceUploadRequestOwner uploadRequestOwner) {
        Utils.checkNotNull(uploadRequestOwner, "uploadRequestOwner");
        this.uploadRequestOwner = uploadRequestOwner;
        return this;
    }
     ...
     * Enum representing the status of a workspace upload request
     */
    public WorkspaceUploadRequest withStatus(WorkspaceUploadRequestStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * List of documents associated with the upload request
     */
    public WorkspaceUploadRequest withDocuments(List<WorkspaceUploadRequestDocument> documents) {
        Utils.checkNotNull(documents, "documents");
     ...
     * List of documents associated with the upload request
     */
    public WorkspaceUploadRequest withDocuments(Optional<? extends List<WorkspaceUploadRequestDocument>> documents) {
        Utils.checkNotNull(documents, "documents");
        this.documents = documents;
        return this;
    }
     ...
     * List of user assignments for the upload request
     */
    public WorkspaceUploadRequest withAssignments(List<WorkspaceUploadRequestAssignment> assignments) {
        Utils.checkNotNull(assignments, "assignments");
     ...
     * List of user assignments for the upload request
     */
    public WorkspaceUploadRequest withAssignments(Optional<? extends List<WorkspaceUploadRequestAssignment>> assignments) {
        Utils.checkNotNull(assignments, "assignments");
        this.assignments = assignments;
        return this;
    }
     ...
     * The date the upload request was created
     */
    public WorkspaceUploadRequest withCreatedDate(OffsetDateTime createdDate) {
        Utils.checkNotNull(createdDate, "createdDate");
     ...
     * The date the upload request was created
     */
    public WorkspaceUploadRequest withCreatedDate(Optional<OffsetDateTime> createdDate) {
        Utils.checkNotNull(createdDate, "createdDate");
        this.createdDate = createdDate;
        return this;
    }
     ...
     * The date the upload request was last updated
     */
    public WorkspaceUploadRequest withUpdatedDate(OffsetDateTime updatedDate) {
        Utils.checkNotNull(updatedDate, "updatedDate");
     ...
     * The date the upload request was last updated
     */
    public WorkspaceUploadRequest withUpdatedDate(Optional<OffsetDateTime> updatedDate) {
        Utils.checkNotNull(updatedDate, "updatedDate");
        this.updatedDate = updatedDate;
        return this;
    }
     ...
     * The due date for the upload request
     */
    public WorkspaceUploadRequest withDueDate(OffsetDateTime dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
     ...
     * The due date for the upload request
     */
    public WorkspaceUploadRequest withDueDate(JsonNullable<OffsetDateTime> dueDate) {
        Utils.checkNotNull(dueDate, "dueDate");
        this.dueDate = dueDate;
        return this;
    }
     ...
     * The date the upload request was sent
     */
    public WorkspaceUploadRequest withSentDate(OffsetDateTime sentDate) {
        Utils.checkNotNull(sentDate, "sentDate");
     ...
     * The date the upload request was sent
     */
    public WorkspaceUploadRequest withSentDate(JsonNullable<OffsetDateTime> sentDate) {
        Utils.checkNotNull(sentDate, "sentDate");
        this.sentDate = sentDate;
        return this;
    }
     ...
     * The date the upload request was completed
     */
    public WorkspaceUploadRequest withCompletedDate(OffsetDateTime completedDate) {
        Utils.checkNotNull(completedDate, "completedDate");
     ...
     * The date the upload request was completed
     */
    public WorkspaceUploadRequest withCompletedDate(JsonNullable<OffsetDateTime> completedDate) {
        Utils.checkNotNull(completedDate, "completedDate");
        this.completedDate = completedDate;
        return this;
    }
     ...
     * Whether the current user can view the upload request
     */
    public WorkspaceUploadRequest withCanView(boolean canView) {
        Utils.checkNotNull(canView, "canView");
        this.canView = canView;
        return this;
    }
     ...
     * Whether the current user can edit the upload request
     */
    public WorkspaceUploadRequest withCanEdit(boolean canEdit) {
        Utils.checkNotNull(canEdit, "canEdit");
        this.canEdit = canEdit;
        return this;
    }
     ...
     * Whether the current user can delete the upload request
     */
    public WorkspaceUploadRequest withCanDelete(boolean canDelete) {
        Utils.checkNotNull(canDelete, "canDelete");
        this.canDelete = canDelete;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        WorkspaceUploadRequest other = (WorkspaceUploadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(WorkspaceUploadRequest.class,
    ...
    public final static class Builder {
        ...
        public WorkspaceUploadRequest build() {

            return new WorkspaceUploadRequest(
                uploadRequestId, workspaceId, name,
                description, uploadRequestOwner, status,
                documents, assignments, createdDate,
                updatedDate, dueDate, sentDate,
