...
public class GetWorkspaceUploadRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceUploadRequestRequest request) {
        ...
        @Override
        public GetWorkspaceUploadRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkspaceUploadRequestResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.GetWorkspaceUploadRequestResponse>() {}));
                } else {
