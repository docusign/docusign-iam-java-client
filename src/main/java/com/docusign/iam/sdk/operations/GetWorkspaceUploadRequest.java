...
public class GetWorkspaceUploadRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceUploadRequestRequest, GetWorkspaceUploadRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetWorkspaceUploadRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceUploadRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceUploadRequestRequest request) throws Exception {
        ...
        @Override
        public GetWorkspaceUploadRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceUploadRequestResponse.Builder resBuilder =
            ...
            GetWorkspaceUploadRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspaceUploadRequestResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
