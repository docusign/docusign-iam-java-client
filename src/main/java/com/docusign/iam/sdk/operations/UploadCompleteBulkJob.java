...
public class UploadCompleteBulkJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadCompleteBulkJobRequest, UploadCompleteBulkJobResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UploadCompleteBulkJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadCompleteBulkJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadCompleteBulkJobRequest request) {
        ...
        @Override
        public UploadCompleteBulkJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadCompleteBulkJobResponse.Builder resBuilder =
                    UploadCompleteBulkJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UploadCompleteBulkJobResponse res = resBuilder.build();
