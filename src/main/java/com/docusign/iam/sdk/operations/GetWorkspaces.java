...
public class GetWorkspaces {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v1/accounts/{accountId}/workspaces",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspacesRequest, GetWorkspacesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetWorkspacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspacesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspacesRequest request) throws Exception {
        ...
        @Override
        public GetWorkspacesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspacesResponse.Builder resBuilder =
            ...
            GetWorkspacesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspacesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspacesResponse(out);
                    return res;
                } else {
