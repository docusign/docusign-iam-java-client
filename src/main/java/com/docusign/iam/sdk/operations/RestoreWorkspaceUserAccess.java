...
public class RestoreWorkspaceUserAccess {
    ...
    public static class Sync extends Base
            implements RequestOperation<RestoreWorkspaceUserAccessRequest, RestoreWorkspaceUserAccessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RestoreWorkspaceUserAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RestoreWorkspaceUserAccessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RestoreWorkspaceUserAccessRequest request) throws Exception {
        ...
        @Override
        public RestoreWorkspaceUserAccessResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RestoreWorkspaceUserAccessResponse.Builder resBuilder =
                    RestoreWorkspaceUserAccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            RestoreWorkspaceUserAccessResponse res = resBuilder.build();
