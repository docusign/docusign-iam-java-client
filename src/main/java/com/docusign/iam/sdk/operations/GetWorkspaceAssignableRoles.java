...
public class GetWorkspaceAssignableRoles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceAssignableRolesRequest, GetWorkspaceAssignableRolesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetWorkspaceAssignableRolesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceAssignableRolesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceAssignableRolesRequest request) throws Exception {
        ...
        @Override
        public GetWorkspaceAssignableRolesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceAssignableRolesResponse.Builder resBuilder =
            ...
            GetWorkspaceAssignableRolesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspaceAssignableRolesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspaceAssignableRolesResponse(out);
                    return res;
                } else {
