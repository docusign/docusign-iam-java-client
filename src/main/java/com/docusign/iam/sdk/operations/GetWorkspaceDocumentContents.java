...
public class GetWorkspaceDocumentContents {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetWorkspaceDocumentContentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceDocumentContentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceDocumentContentsRequest request) throws Exception {
        ...
        @Override
        public GetWorkspaceDocumentContentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceDocumentContentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "application/octet-stream")) {
                resBuilder.getWorkspaceDocumentContentsResponse(response.body());
            }

            GetWorkspaceDocumentContentsResponse res = resBuilder.build();
