...
public class GetWorkspaceBrand {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceBrandRequest, GetWorkspaceBrandResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWorkspaceBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceBrandRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceBrandRequest request) {
        ...
        @Override
        public GetWorkspaceBrandResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceBrandResponse.Builder resBuilder =
            ...
            GetWorkspaceBrandResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkspaceBrandResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.GetWorkspaceBrandResponse>() {}));
                } else {
