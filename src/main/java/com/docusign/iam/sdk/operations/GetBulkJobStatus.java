...
public class GetBulkJobStatus {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v1/accounts/{accountId}/upload/jobs/{jobId}",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBulkJobStatusRequest, GetBulkJobStatusResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBulkJobStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBulkJobStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBulkJobStatusRequest request) {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetBulkJobStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBulkJobStatusResponse.Builder resBuilder =
            ...
            GetBulkJobStatusResponse res = resBuilder.build();
