...
public class GetWorkspaceUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceUsersRequest, GetWorkspaceUsersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWorkspaceUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceUsersRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "404", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetWorkspaceUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceUsersResponse.Builder resBuilder =
            ...
            GetWorkspaceUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspaceUsersResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspaceUsersResponse(out);
                    return res;
                } else {
