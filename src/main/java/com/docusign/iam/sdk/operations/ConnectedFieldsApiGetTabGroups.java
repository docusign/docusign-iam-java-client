...
public class ConnectedFieldsApiGetTabGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectedFieldsApiGetTabGroupsRequest, ConnectedFieldsApiGetTabGroupsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ConnectedFieldsApiGetTabGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectedFieldsApiGetTabGroupsRequest.class);
        ...
        public ConnectedFieldsApiGetTabGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            ConnectedFieldsApiGetTabGroupsResponse.Builder resBuilder =
            ...
            ConnectedFieldsApiGetTabGroupsResponse res = resBuilder.build();
