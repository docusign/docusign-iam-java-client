...
public class PauseNewWorkflowInstances {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PauseNewWorkflowInstancesRequest request) {
        ...
        @Override
        public PauseNewWorkflowInstancesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPauseNewWorkflowInstancesSuccess(Utils.unmarshal(response, new TypeReference<PauseNewWorkflowInstancesSuccess>() {}));
                } else {
