...
public class PauseNewWorkflowInstances {
    ...
    public static class Sync extends Base
            implements RequestOperation<PauseNewWorkflowInstancesRequest, PauseNewWorkflowInstancesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(PauseNewWorkflowInstancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PauseNewWorkflowInstancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PauseNewWorkflowInstancesRequest request) throws Exception {
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "409", "4XX", "500", "5XX")) {
        ...
        @Override
        public PauseNewWorkflowInstancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PauseNewWorkflowInstancesResponse.Builder resBuilder =
            ...
            PauseNewWorkflowInstancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PauseNewWorkflowInstancesSuccess out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPauseNewWorkflowInstancesSuccess(out);
                    return res;
                } else {
