...
public class GetWorkspaceDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceDocumentRequest, GetWorkspaceDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWorkspaceDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceDocumentRequest request) throws Exception {
        ...
        @Override
        public GetWorkspaceDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceDocumentResponse.Builder resBuilder =
            ...
            GetWorkspaceDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspaceDocumentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspaceDocumentResponse(out);
                    return res;
                } else {
