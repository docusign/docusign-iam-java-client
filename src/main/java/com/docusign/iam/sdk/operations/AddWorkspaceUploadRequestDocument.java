...
import com.docusign.iam.sdk.models.operations.AddWorkspaceUploadRequestDocumentRequest;
...
public class AddWorkspaceUploadRequestDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddWorkspaceUploadRequestDocumentRequest, AddWorkspaceUploadRequestDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddWorkspaceUploadRequestDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddWorkspaceUploadRequestDocumentRequest.class, new TypeReference<AddWorkspaceUploadRequestDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddWorkspaceUploadRequestDocumentRequest request) throws Exception {
        ...
        @Override
        public AddWorkspaceUploadRequestDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddWorkspaceUploadRequestDocumentResponse.Builder resBuilder =
            ...
            AddWorkspaceUploadRequestDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.AddWorkspaceUploadRequestDocumentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAddWorkspaceUploadRequestDocumentResponse(out);
                    return res;
                } else {
