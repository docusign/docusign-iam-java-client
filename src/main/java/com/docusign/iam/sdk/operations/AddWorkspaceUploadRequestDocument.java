...
public class AddWorkspaceUploadRequestDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddWorkspaceUploadRequestDocumentRequest request) {
        ...
        @Override
        public AddWorkspaceUploadRequestDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAddWorkspaceUploadRequestDocumentResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.AddWorkspaceUploadRequestDocumentResponse>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw ErrorDetails.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
