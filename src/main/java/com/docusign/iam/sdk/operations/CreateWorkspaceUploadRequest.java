...
public class CreateWorkspaceUploadRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateWorkspaceUploadRequestRequest, CreateWorkspaceUploadRequestResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateWorkspaceUploadRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateWorkspaceUploadRequestRequest.class, new TypeReference<CreateWorkspaceUploadRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWorkspaceUploadRequestRequest request) throws Exception {
        ...
        @Override
        public CreateWorkspaceUploadRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateWorkspaceUploadRequestResponse.Builder resBuilder =
                    CreateWorkspaceUploadRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateWorkspaceUploadRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetWorkspaceUploadRequestResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspaceUploadRequestResponse(out);
                    return res;
                } else {
