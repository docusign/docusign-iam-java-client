...
public class CreateWorkspaceUploadRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWorkspaceUploadRequestRequest request) {
        ...
        @Override
        public CreateWorkspaceUploadRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkspaceUploadRequestResponse(Utils.unmarshal(response, new TypeReference<GetWorkspaceUploadRequestResponse>() {}));
                } else {
