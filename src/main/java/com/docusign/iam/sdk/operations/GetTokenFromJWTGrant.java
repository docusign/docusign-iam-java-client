...
public class GetTokenFromJWTGrant {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(JWTGrant request) {
        ...
        @Override
        public GetTokenFromJWTGrantResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withJWTGrantResponse(Utils.unmarshal(response, new TypeReference<JWTGrantResponse>() {}));
                } else {
