...
public class CompleteWorkspaceUploadRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CompleteWorkspaceUploadRequestRequest, CompleteWorkspaceUploadRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(CompleteWorkspaceUploadRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CompleteWorkspaceUploadRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CompleteWorkspaceUploadRequestRequest request) throws Exception {
        ...
        @Override
        public CompleteWorkspaceUploadRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CompleteWorkspaceUploadRequestResponse.Builder resBuilder =
                    CompleteWorkspaceUploadRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CompleteWorkspaceUploadRequestResponse res = resBuilder.build();
