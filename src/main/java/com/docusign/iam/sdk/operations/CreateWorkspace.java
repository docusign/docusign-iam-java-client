...
public class CreateWorkspace {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateWorkspaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateWorkspaceRequest.class, new TypeReference<CreateWorkspaceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWorkspaceRequest request) throws Exception {
        ...
        public CreateWorkspaceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.CreateWorkspaceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateWorkspaceResponse(out);
                    return res;
                } else {
