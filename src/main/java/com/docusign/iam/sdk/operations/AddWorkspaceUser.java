...
public class AddWorkspaceUser {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AddWorkspaceUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddWorkspaceUserRequest.class, new TypeReference<AddWorkspaceUserRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddWorkspaceUserRequest request) throws Exception {
        ...
        @Override
        public AddWorkspaceUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddWorkspaceUserResponse.Builder resBuilder =
            ...
            AddWorkspaceUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateWorkspaceUserResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateWorkspaceUserResponse(out);
                    return res;
                } else {
