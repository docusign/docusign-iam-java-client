...
public class GetTokenFromRefreshTokenOperation implements RequestOperation<AuthorizationCodeGrant, GetTokenFromRefreshTokenResponse> {
    ...
    private final GetTokenFromRefreshTokenSecurity security;
    private final Optional<String> serverURL;
    private final Optional<Options> options;

    public GetTokenFromRefreshTokenOperation(
