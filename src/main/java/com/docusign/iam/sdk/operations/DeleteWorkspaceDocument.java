...
public class DeleteWorkspaceDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteWorkspaceDocumentRequest, DeleteWorkspaceDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteWorkspaceDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteWorkspaceDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteWorkspaceDocumentRequest request) throws Exception {
        ...
        @Override
        public DeleteWorkspaceDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteWorkspaceDocumentResponse.Builder resBuilder =
                    DeleteWorkspaceDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            DeleteWorkspaceDocumentResponse res = resBuilder.build();
