...
public class GetWorkflowInstance {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkflowInstanceRequest request) {
        ...
        @Override
        public GetWorkflowInstanceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWorkflowInstance(Utils.unmarshal(response, new TypeReference<WorkflowInstance>() {}));
                } else {
