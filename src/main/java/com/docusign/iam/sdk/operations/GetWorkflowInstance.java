...
public class GetWorkflowInstance {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkflowInstanceRequest, GetWorkflowInstanceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetWorkflowInstanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkflowInstanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkflowInstanceRequest request) throws Exception {
        ...
        @Override
        public GetWorkflowInstanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkflowInstanceResponse.Builder resBuilder =
            ...
            GetWorkflowInstanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WorkflowInstance out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWorkflowInstance(out);
                    return res;
                } else {
