...
public class RevokeWorkspaceUserAccess {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeWorkspaceUserAccessRequest, RevokeWorkspaceUserAccessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(RevokeWorkspaceUserAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeWorkspaceUserAccessRequest.class, new TypeReference<RevokeWorkspaceUserAccessRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeWorkspaceUserAccessRequest request) throws Exception {
        ...
        @Override
        public RevokeWorkspaceUserAccessResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeWorkspaceUserAccessResponse.Builder resBuilder =
                    RevokeWorkspaceUserAccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            RevokeWorkspaceUserAccessResponse res = resBuilder.build();
