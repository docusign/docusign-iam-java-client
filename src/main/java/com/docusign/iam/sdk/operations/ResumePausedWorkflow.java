...
public class ResumePausedWorkflow {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResumePausedWorkflowRequest request) {
        ...
        @Override
        public ResumePausedWorkflowResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResumeNewWorkflowInstancesSuccess(Utils.unmarshal(response, new TypeReference<ResumeNewWorkflowInstancesSuccess>() {}));
                } else {
