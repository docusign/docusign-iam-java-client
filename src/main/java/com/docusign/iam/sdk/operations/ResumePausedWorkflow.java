...
public class ResumePausedWorkflow {
    ...
    public static class Sync extends Base
            implements RequestOperation<ResumePausedWorkflowRequest, ResumePausedWorkflowResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(ResumePausedWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResumePausedWorkflowRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResumePausedWorkflowRequest request) throws Exception {
        ...
        @Override
        public ResumePausedWorkflowResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResumePausedWorkflowResponse.Builder resBuilder =
            ...
            ResumePausedWorkflowResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ResumeNewWorkflowInstancesSuccess out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withResumeNewWorkflowInstancesSuccess(out);
                    return res;
                } else {
