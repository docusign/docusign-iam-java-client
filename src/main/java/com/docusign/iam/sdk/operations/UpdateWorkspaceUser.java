...
public class UpdateWorkspaceUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateWorkspaceUserRequest, UpdateWorkspaceUserResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateWorkspaceUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateWorkspaceUserRequest.class, new TypeReference<UpdateWorkspaceUserRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateWorkspaceUserRequest request) throws Exception {
        ...
        @Override
        public UpdateWorkspaceUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateWorkspaceUserResponse.Builder resBuilder =
            ...
            UpdateWorkspaceUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.UpdateWorkspaceUserResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateWorkspaceUserResponse(out);
                    return res;
                } else {
