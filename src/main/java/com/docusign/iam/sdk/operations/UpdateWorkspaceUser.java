...
public class UpdateWorkspaceUser {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateWorkspaceUserRequest request) {
        ...
        @Override
        public UpdateWorkspaceUserResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateWorkspaceUserResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.UpdateWorkspaceUserResponse>() {}));
                } else {
