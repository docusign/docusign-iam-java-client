...
public class AddWorkspaceDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddWorkspaceDocumentRequest request) {
        ...
        @Override
        public AddWorkspaceDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateWorkspaceDocumentResponse(Utils.unmarshal(response, new TypeReference<CreateWorkspaceDocumentResponse>() {}));
                } else {
