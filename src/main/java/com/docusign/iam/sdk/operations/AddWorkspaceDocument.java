...
import com.docusign.iam.sdk.models.operations.AddWorkspaceDocumentRequest;
...
public class AddWorkspaceDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddWorkspaceDocumentRequest, AddWorkspaceDocumentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddWorkspaceDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddWorkspaceDocumentRequest.class, new TypeReference<AddWorkspaceDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddWorkspaceDocumentRequest request) throws Exception {
        ...
        @Override
        public AddWorkspaceDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddWorkspaceDocumentResponse.Builder resBuilder =
                    AddWorkspaceDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AddWorkspaceDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateWorkspaceDocumentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateWorkspaceDocumentResponse(out);
                    return res;
                } else {
