...
public class GetAgreement {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAgreementRequest, GetAgreementResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetAgreementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAgreementRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAgreementRequest request) throws Exception {
        ...
        @Override
        public GetAgreementResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAgreementResponse.Builder resBuilder =
            ...
            GetAgreementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Agreement out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAgreement(out);
                    return res;
                } else {
