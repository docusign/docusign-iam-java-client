...
public class CancelWorkflowInstance {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelWorkflowInstanceRequest, CancelWorkflowInstanceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(CancelWorkflowInstanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelWorkflowInstanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelWorkflowInstanceRequest request) throws Exception {
        ...
        @Override
        public CancelWorkflowInstanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelWorkflowInstanceResponse.Builder resBuilder =
            ...
            CancelWorkflowInstanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.CancelWorkflowInstanceResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCancelWorkflowInstanceResponse(out);
                    return res;
                } else {
