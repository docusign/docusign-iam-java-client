...
public class CancelWorkflowInstance {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelWorkflowInstanceRequest request) {
        ...
        @Override
        public CancelWorkflowInstanceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCancelWorkflowInstanceResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.CancelWorkflowInstanceResponse>() {}));
                } else {
