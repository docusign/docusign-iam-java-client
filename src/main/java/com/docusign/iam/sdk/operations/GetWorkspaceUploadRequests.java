...
public class GetWorkspaceUploadRequests {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceUploadRequestsRequest request) {
        ...
        @Override
        public GetWorkspaceUploadRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkspaceUploadRequestsResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.GetWorkspaceUploadRequestsResponse>() {}));
                } else {
