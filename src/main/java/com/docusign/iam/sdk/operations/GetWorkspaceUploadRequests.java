...
public class GetWorkspaceUploadRequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceUploadRequestsRequest, GetWorkspaceUploadRequestsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWorkspaceUploadRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceUploadRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceUploadRequestsRequest request) throws Exception {
        ...
        @Override
        public GetWorkspaceUploadRequestsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceUploadRequestsResponse.Builder resBuilder =
            ...
            GetWorkspaceUploadRequestsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspaceUploadRequestsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspaceUploadRequestsResponse(out);
                    return res;
                } else {
