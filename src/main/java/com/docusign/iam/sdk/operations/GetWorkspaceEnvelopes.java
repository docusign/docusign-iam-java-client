...
public class GetWorkspaceEnvelopes {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkspaceEnvelopesRequest, GetWorkspaceEnvelopesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWorkspaceEnvelopesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkspaceEnvelopesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceEnvelopesRequest request) throws Exception {
        ...
        @Override
        public GetWorkspaceEnvelopesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWorkspaceEnvelopesResponse.Builder resBuilder =
            ...
            GetWorkspaceEnvelopesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.GetWorkspaceEnvelopesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetWorkspaceEnvelopesResponse(out);
                    return res;
                } else {
