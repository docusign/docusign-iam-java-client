...
public class GetWorkspaceEnvelopes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWorkspaceEnvelopesRequest request) {
        ...
        @Override
        public GetWorkspaceEnvelopesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetWorkspaceEnvelopesResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.GetWorkspaceEnvelopesResponse>() {}));
                } else {
