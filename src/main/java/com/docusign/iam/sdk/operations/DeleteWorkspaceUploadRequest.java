...
public class DeleteWorkspaceUploadRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteWorkspaceUploadRequestRequest, DeleteWorkspaceUploadRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(DeleteWorkspaceUploadRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteWorkspaceUploadRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteWorkspaceUploadRequestRequest request) throws Exception {
        ...
        @Override
        public DeleteWorkspaceUploadRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteWorkspaceUploadRequestResponse.Builder resBuilder =
                    DeleteWorkspaceUploadRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            DeleteWorkspaceUploadRequestResponse res = resBuilder.build();
