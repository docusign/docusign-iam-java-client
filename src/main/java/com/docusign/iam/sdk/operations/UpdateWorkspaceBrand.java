...
public class UpdateWorkspaceBrand {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateWorkspaceBrandRequest, UpdateWorkspaceBrandResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateWorkspaceBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateWorkspaceBrandRequest.class, new TypeReference<UpdateWorkspaceBrandRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateWorkspaceBrandRequest request) {
        ...
        @Override
        public UpdateWorkspaceBrandResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateWorkspaceBrandResponse.Builder resBuilder =
            ...
            UpdateWorkspaceBrandResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateWorkspaceBrandResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.UpdateWorkspaceBrandResponse>() {}));
                } else {
