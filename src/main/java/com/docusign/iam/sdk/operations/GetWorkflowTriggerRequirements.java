...
public class GetWorkflowTriggerRequirements {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWorkflowTriggerRequirementsRequest, GetWorkflowTriggerRequirementsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
            super(sdkConfiguration, options);
        }

        private HttpRequest onBuildRequest(GetWorkflowTriggerRequirementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWorkflowTriggerRequirementsRequest.class);
