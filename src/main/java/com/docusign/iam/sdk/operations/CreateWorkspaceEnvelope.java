...
public class CreateWorkspaceEnvelope {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWorkspaceEnvelopeRequest request) {
        ...
        @Override
        public CreateWorkspaceEnvelopeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateWorkspaceEnvelopeResponse(Utils.unmarshal(response, new TypeReference<com.docusign.iam.sdk.models.components.CreateWorkspaceEnvelopeResponse>() {}));
                } else {
