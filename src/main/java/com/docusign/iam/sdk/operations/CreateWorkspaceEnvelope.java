...
public class CreateWorkspaceEnvelope {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateWorkspaceEnvelopeRequest, CreateWorkspaceEnvelopeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateWorkspaceEnvelopeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateWorkspaceEnvelopeRequest.class, new TypeReference<CreateWorkspaceEnvelopeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWorkspaceEnvelopeRequest request) throws Exception {
        ...
        @Override
        public CreateWorkspaceEnvelopeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateWorkspaceEnvelopeResponse.Builder resBuilder =
            ...
            CreateWorkspaceEnvelopeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.docusign.iam.sdk.models.components.CreateWorkspaceEnvelopeResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateWorkspaceEnvelopeResponse(out);
                    return res;
                } else {
