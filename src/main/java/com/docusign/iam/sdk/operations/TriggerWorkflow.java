...
public class TriggerWorkflow {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TriggerWorkflowRequest request) throws Exception {
        ...
        @Override
        public TriggerWorkflowResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ...
                    res.withTriggerWorkflowSuccess(out);
                    return res;
                } else {
