...
public class TriggerWorkflow {
    ...
    public static class Sync extends Base
            implements RequestOperation<TriggerWorkflowRequest, TriggerWorkflowResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TriggerWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TriggerWorkflowRequest.class, new TypeReference<TriggerWorkflowRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TriggerWorkflowRequest request) {
        ...
        @Override
        public TriggerWorkflowResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TriggerWorkflowResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTriggerWorkflowSuccess(Utils.unmarshal(response, new TypeReference<TriggerWorkflowSuccess>() {}));
                } else {
